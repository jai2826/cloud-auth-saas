...
// ../../node_modules/.pnpm/wrangler@4.98.0_@cloudflare+workers-types@4.20260606.1/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-console
...
// ../../node_modules/.pnpm/wrangler@4.98.0_@cloudflare+workers-types@4.20260606.1/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-process
...
// ../../node_modules/.pnpm/wrangler@4.98.0_@cloudflare+workers-types@4.20260606.1/node_modules/wrangler/templates/modules-watch-stub.js
...
// .wrangler/tmp/bundle-2zQZyr/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-2zQZyr/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
async function evaluateAccess(pool, tenantId, action, resource, context2 = {}) {
  ...
  try {
    ...
    for (const row of res.rows) {
      ...
      const met = Object.entries(conditions).every(([key, val]) => context2[key] === val);
      if (met) return true;
    }
    return false;
  } finally {
...
__name(evaluateAccess, "evaluateAccess");

// src/middleware/fga.ts
var requirePermission = /* @__PURE__ */ __name((action, resourceTemplate) => {
  return createMiddleware(async (c, next) => {
    const session = await c.get("session");
    if (!session) return c.json({ error: "Unauthorized" }, 401);
    const allowed = await evaluateAccess(
      c.env.POOL,
      // Your pg Pool instance
      session.user.id,
      action,
      resourceTemplate
    );
...
app.use("*", async (c, next) => {
  const pool = new Pool({
    ...
    max: 1
    // Crucial: limit connections per Worker instance
  });
  c.set("pool", pool);
  await next();
});
app.get(
  "/api/docs/:id",
  requirePermission("read", "document:view"),
  (c) => c.json({ data: "Secret Document Content" })
);
...
// ../../node_modules/.pnpm/wrangler@4.98.0_@cloudflare+workers-types@4.20260606.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// ../../node_modules/.pnpm/wrangler@4.98.0_@cloudflare+workers-types@4.20260606.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// ../../node_modules/.pnpm/wrangler@4.98.0_@cloudflare+workers-types@4.20260606.1/node_modules/wrangler/templates/middleware/common.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
